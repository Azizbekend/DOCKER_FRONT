            ...
            <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <div className="bg-white divide-y divide-gray-200">
                        {list.flatMap((contact, key) => contact.company.id != 6 && contact.users.length > 0
                            ...
                            <div className={`${gridGridColumns}`}>
                                <div className="px-3 py-2 text-sm text-gray-800 font-medium">{idblock++}</div>
                                <div className="px-3 py-2 text-sm text-gray-800 font-medium">{contact.company.companyRole}</div>
