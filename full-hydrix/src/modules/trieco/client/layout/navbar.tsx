...
export const Navbar = () => {
    ...
    // @ts-ignore
    return (
        <div className="flex flex-row gap-6 w-full justify-end relative max-w-full h-[51px]">
            ...
            <div className="flex flex-row items-center justify-center gap-9 mr-7">
                ...
                <NavbarItem isActive={location.pathname === "/trieco/client/orders"} link="/trieco/client/orders" title="Заявки" icon="clipboard-link" />
            </div>
