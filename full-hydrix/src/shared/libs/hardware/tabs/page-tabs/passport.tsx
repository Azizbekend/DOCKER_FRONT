                ...
                <PassportBlockContainer
                    ...
                    children={
                        <div className="grid gap-4" style={{ gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))" }}>
                            <div className="bg-[#f8fafc] rounded-[12px] p-[16px] text-[13px]">Включений<br /><b className="mt-[6px] text-[18px]">8</b></div>
                            <div className="bg-[#f8fafc] rounded-[12px] p-[16px] text-[13px]">Выключений<br /><b className="mt-[6px] text-[18px]">8</b></div>
                            <div className="bg-[#f8fafc] rounded-[12px] p-[16px] text-[13px]">Средняя работа<br /><b className="mt-[6px] text-[18px]">2 ч 45 мин</b></div>
                            <div className="bg-[#f8fafc] rounded-[12px] p-[16px] text-[13px]">Время в работе<br /><b className="mt-[6px] text-[18px]">91.7%</b></div>
                            <br />
                            <div className="bg-[#f8fafc] rounded-[12px] p-[16px] text-[13px]">Кол-во критичных аварий<br /><b className="mt-[6px] text-[18px]">50</b></div>
                            <div className="bg-[#f8fafc] rounded-[12px] p-[16px] text-[13px]">Кол-во важных аварий<br /><b className="mt-[6px] text-[18px]">50</b></div>
                            <div className="bg-[#f8fafc] rounded-[12px] p-[16px] text-[13px]">Кол-во заявок<br /><b className="mt-[6px] text-[18px]">50</b></div>
                        </div>
                    }
                />
            </div>
