...
import { HardwareControlle, HardwareReview, HardwareServes } from "@/packages/widgets/hardware-panel-tabs";
import { getHardwareStatus } from "@/packages/shared-components/hardware/hardware-status";
